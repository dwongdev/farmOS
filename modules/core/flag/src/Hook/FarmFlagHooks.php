    ...
    public function entityTypeBuild(array &$entity_types)
    {
        ...
        foreach ([
            ...
            if (!empty($entity_types[$entity_type])) {
                ...
                $route_providers['flag'] = \Drupal\farm_flag\Routing\EntityFlagActionRouteProvider::class;
                ...
                $entity_types[$entity_type]->setFormClass('flag-action-form', \Drupal\farm_flag\Form\EntityFlagActionForm::class);
            }
        }
    }
    /**
