...
class FarmUiThemeHooks
{
    ...
    public function entityTypeBuild(array &$entity_types)
    {
        ...
        $target_entity_types = [
            'asset' => \Drupal\farm_ui_theme\Form\AssetForm::class,
            'log' => \Drupal\farm_ui_theme\Form\LogForm::class,
            'organization' => \Drupal\farm_ui_theme\Form\OrganizationForm::class,
            'plan' => \Drupal\farm_ui_theme\Form\PlanForm::class,
            'taxonomy_term' => \Drupal\farm_ui_theme\Form\TaxonomyTermForm::class,
        ];
