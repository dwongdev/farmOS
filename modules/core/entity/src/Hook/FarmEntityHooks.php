...
class FarmEntityHooks
{
    ...
    public function entityTypeBuild(array &$entity_types)
    {
        ...
        foreach ([
            ...
            if (!empty($entity_types[$entity_type])) {
                ...
                $entity_types[$bundle_entity_type]->setHandlerClass('access', \Drupal\entity\EntityAccessControlHandler::class);
                $entity_types[$bundle_entity_type]->setHandlerClass('permission_provider', \Drupal\entity\EntityPermissionProvider::class);
            }
        }
        ...
        foreach ([
            ...
            if (!empty($entity_types[$entity_type])) {
                ...
                $entity_types[$entity_type]->setHandlerClass('bundle_plugin', \Drupal\farm_entity\BundlePlugin\FarmEntityBundlePluginHandler::class);
                // Override default entity route provider class.
                $route_providers = $entity_types[$entity_type]->getRouteProviderClasses();
                $route_providers['default'] = \Drupal\farm_entity\Routing\EntityRouteProvider::class;
                ...
                $route_providers['default'] = \Drupal\farm_entity\Routing\BundleEntityTypeRouteProvider::class;
    ...
    public function entityFieldStorageInfoAlter(&$fields, \Drupal\Core\Entity\EntityTypeInterface $entity_type)
    {
    ...
    public function entityPresave(\Drupal\Core\Entity\EntityInterface $entity)
    {
        ...
        if (!in_array($entity->getEntityTypeId(), $entity_types) || !$entity instanceof \Drupal\Core\Entity\RevisionLogInterface || !$entity instanceof \Drupal\Core\Entity\FieldableEntityInterface) {
            return;
        }
        ...
        if ($entity_type instanceof \Drupal\Core\Entity\RevisionableEntityBundleInterface && $entity_type->shouldCreateNewRevision() && $entity->getEntityType()->isRevisionable()) {
