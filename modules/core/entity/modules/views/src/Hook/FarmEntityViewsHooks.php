    ...
    public function entityTypeBuild(array &$entity_types)
    {
        ...
        foreach ([
            ...
            if (!empty($entity_types[$entity_type])) {
                ...
                $views_data_class = \Drupal\farm_entity_views\FarmEntityViewsData::class;
                switch ($entity_type) {
                    case 'log':
                        $views_data_class = \Drupal\farm_entity_views\FarmLogViewsData::class;
                        break;
                    case 'quantity':
                        $views_data_class = \Drupal\farm_entity_views\FarmQuantityViewsData::class;
                        break;
                }
